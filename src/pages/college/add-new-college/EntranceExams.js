...
import { TextField, Button, Grid, Typography, Checkbox } from "@mui/material";
...
const EntranceExams = () => {
  ...
  return (
    <>
    <Typography variant="h5" mb={2}>ENTRANCE EXAMS</Typography>
    <Typography variant="p">Select all the exams through which students can get 
    admission in your college/ institute</Typography>
    <form>
      {/* First Row */}
      <Grid container mb={2} mt={2}>
      <Grid  item xs={4}>
        <Typography>Design</Typography>
        <Grid style={{display: 'flex', flexDirection: 'end'}}>
      ...
      <Grid container mb={2}>
        <Grid item xs={4}>
          <Typography>Other (If any entrance/criteria is not in the list)</Typography>
          <TextField
